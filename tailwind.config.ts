  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "estimate-pulse": "estimate-pulse 2s ease-in-out infinite",
      },
      boxShadow: {
        "metric": "0 1px 3px 0 rgb(0 0 0 / 0.05), 0 1px 2px -1px rgb(0 0 0 / 0.05)",
        "metric-hover": "0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)",
        "card-critical": "0 0 0 1px hsl(var(--critical) / 0.2), 0 4px 12px -2px hsl(var(--critical) / 0.15)",
      },
    },
  },
