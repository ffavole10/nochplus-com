...
export const DEFAULT_Q_AND_A: { question: string; answer: string; category: KBCategory }[] = [
  ...
  { category: "Company", question: "What's AutoHeal?", answer: "AutoHeal is our AI-powered reliability technology platform currently in development. It will provide intelligent diagnostics, predictive maintenance alerts, and automated issue detection for EV chargers. AutoHeal represents the future of proactive charger reliability, moving from reactive fix-it service to predictive prevention." },
